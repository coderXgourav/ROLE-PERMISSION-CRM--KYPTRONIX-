...
<!-- Mirrored from codervent.com/syndron/demo/vertical/errors-404-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2024 17:09:08 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
...
<body>
	<!-- wrapper -->
	<div class="wrapper">
		<nav class="navbar navbar-expand-lg navbar-light bg-white rounded fixed-top rounded-0 ">
			<div class="container-fluid " style="display:flex; justify-content:center;">
				<a class="navbar-brand" href="#" class="text-center ">
					<img src="/assets/images/logo-icon.png" width="70" alt="logo" class="ml-5" />
				</a>
					...
					<div class="row g-0">
						<div class="col col-xl-5">
							<div class="card-body p-4">
								...
								<p>You do not have permission to access this page. Please contact your administrator for assistance.</p>
								<div class="mt-5"> <a href="javascript:;" class="btn btn-primary btn-lg px-md-5 radius-30">Go Back</a>
