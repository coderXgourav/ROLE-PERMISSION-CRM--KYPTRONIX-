										...
										<ul class="list-group list-group-flush">
									       ...
									       <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										 	<a href="{{route('admin.sub-service-list',['id'=>$data->service_id])}}">
												...
												Sub Services</h6></a>
												<span class="text-secondary">{{$total_sub_service;}}</span>
											</li>
											...
											<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
												...
												<span class="text-secondary">{{$total_leads}}</span>
											</li>
											<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										       <a href="{{route('admin.service_invoices',['id'=>$data->service_id])}}">
												...
												<span class="text-secondary">{{$total_invoices}}</span>
											</li>
											<!--<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
