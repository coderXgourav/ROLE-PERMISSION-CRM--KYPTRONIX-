...
<div class="row">
                    <div class="col-lg-8 mx-auto">
						...
						<div class="card">
							<form id="add_team_members_form">
							<div class="card-body p-4">
								<h5 class="mb-4">Add Team Member </h5>
								   <div class="row mb-3">
									...
									<div class="row">
										...
										<div class="col-sm-9">
											<div class="d-md-flex d-grid align-items-center gap-3">
												<button type="submit" class="btn btn-primary px-4" style="height:46px;" id="btn" onclick="addMembers()">Submit</button>
