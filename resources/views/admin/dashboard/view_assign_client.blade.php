									...
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
											...
											<div class="mt-3">
												...
												<p class="text-secondary mb-1">{{$customer_data->customer_email}}</p>
												<p class="text-muted font-size-sm">{{$customer_data->customer_number}}</p>
												<p class="text-muted font-size-sm">{{$services_data->name}}</p>
											
												<!--<button class="btn btn-primary">Follow</button>
												<button class="btn btn-outline-primary">Message</button>-->
											</div>
											<?php $id=encrypt($customer_data->customer_id);?>
											 <a href="{{route('admin.chat',['id'=>$id])}}" class="btn btn-primary">Remark</a>
