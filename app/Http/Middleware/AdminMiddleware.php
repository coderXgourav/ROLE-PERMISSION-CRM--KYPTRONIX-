...
class AdminMiddleware
{
     ...
     private function hasAccess($admin_data, $routeName)
    {
        ...
        $permissions = [
            ...
            'admin.assign' => ($admin_data->assign_manage)?1:0,
            ...
            'admin.all-service' => ($admin_data->service_view>0)?1:0, 
            ...
            'admin.view-service' =>  $admin_data->service_view?1:0,
            'admin.team-member' => 1,
            ...
            'admin.manager_convert_to_clients' =>  1,
            'admin.member_convert_to_client' =>1,
            'admin.view_manager_details' => 1,
            'admin.view-members' =>1,
            'admin.view-operation-managers' =>1,
            ...
            'admin.team-manager-list' =>1,
            'admin.leads-view' => $admin_data->leads_view,
            'admin.all-reports' => $admin_data->report_count>0?1:0 ,
            'admin.individual-report' =>$admin_data->report_individual>0?1:0 ,
            'admin.staff-report' =>$admin_data->report_staff>0?1:0 ,
            'admin.business-report' =>$admin_data->report_business>0?1:0 ,
            'admin-logout' => 1,
            'admin.login-times'=>1,
            'not-access'=>1,
            'admin-dashboard'=>1,
            ...
            'admin.show-team-member-list'=> $admin_data->user_type=="team_manager"?1:0,
            ...
            'admin.import-leads'=>1,
            'admin.show-team-manager-list'=>1,
            'admin.operation-manger-list' => 1,
            'change_status'=>1,
            'admin.login-list'=>1,
            'admin.subservices'=>1,
