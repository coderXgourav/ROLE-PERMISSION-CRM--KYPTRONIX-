...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('permission', function (Blueprint $table) {
            ...
            // $table->string('client_financial_data_permission')->default(0)->nullable();
            // $table->string('client_contact_permission')->default(0)->nullable();
            // $table->string('delete_client_record_permission')->default(0)->nullable();
            // $table->string('delete_all_record_permission')->default(0)->nullable();
